...
namespace LZBigNoodles.Models
{
    public static class DbInitializer
    {
        ...
        {
            if (context.Noodles.Any())//判断Noodles是否为空
            {
                return ;
            }
            //
            context.AddRange//添加数据
            (
                ...
                new Noodle { Name = "ikun", Price = 15, ShortDescription = "真爱粉团", LongDescription = "鸡", ImageUrl = "/images/一窝丝.png" }
